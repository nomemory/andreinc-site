const reNums = (s) => {
    ...
    s.setup = () => {
        ...
        buff.arrowDashed(canvas, [3,3], piX, vG.y + 2*r, piX, vG.y + 5);
        buff.circle(piX, vG.y + 2*r, 20);
        ...
        buff.arrowDashed(canvas, [3,3], eX, vG.y - 2*r, eX, vG.y - 5);
        buff.circle(eX, vG.y - 2*r, 20);
        buff.fill(theme.radiusColor);
        ...
        buff.arrowDashed(canvas, [3,3], stwX, vG.y + 3*r, stwX, vG.y + 5);
        buff.circle(stwX, vG.y + 3*r, 20);
        buff.fill(theme.radiusColor);
        ...
        buff.arrowDashed(canvas, [3,3], tfX, vG.y - 3*r, tfX, vG.y - 5);
        buff.circle(tfX, vG.y - 3*r, 30);
        buff.fill(theme.radiusColor);
        ...
        buff.arrowDashed(canvas, [3,3], fX, vG.y - r, fX, vG.y - 5);
        buff.circle(fX, vG.y - r, 20);
        buff.fill(theme.radiusColor);
        ...
        buff.arrowDashed(canvas, [3,3], mttX, vG.y - 3*r, mttX, vG.y - 5);
        buff.circle(mttX, vG.y - 3*r, 40);
        buff.fill(theme.radiusColor);
        ...
        buff.arrowDashed(canvas, [3,3], msthX, vG.y + 3*r, msthX, vG.y + 5);
        buff.circle(msthX, vG.y + 3*r, 20);
        buff.fill(theme.radiusColor);
