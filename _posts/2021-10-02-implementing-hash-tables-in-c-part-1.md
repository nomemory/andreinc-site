...
Before jumping into implementing the enumerated methods, it's good to clarify a few things that are not obvious from the interface itself.
...
### `ch_hash_get_node` and `ch_hash_get`
